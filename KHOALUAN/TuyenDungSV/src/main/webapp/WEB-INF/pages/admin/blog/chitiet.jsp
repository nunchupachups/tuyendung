...
<body>
    ...
    <div class="container">
    	<div style="height:20px;">
          ...
          <h3 style="color: rgb(6, 109, 70);" class="mb-5">Thông tin blog</h3>
          <div style="margin-left: 40px;">
            ...
            <div style="margin-left: 50px;margin-bottom: 30px;">
          	...
          	<h5 style="color: green; border-left: 5px solid green;padding-left: 10px;" class="mb-3">Tác giả</h5>
            <div style="margin-left: 50px;margin-bottom: 30px;">
	            ${blog.getTacGia() }
            </div>
            ...
            <div style="margin-left: 50px;margin-bottom: 30px;">
	            <div style="width: 900px; margin-bottom: 20px;">
	            	<img style="width: 100%;" alt="" src="${contextPath }/${blog.getAnh()}">
	            </div>
            </div>
            <h5 style="color: green; border-left: 5px solid green;padding-left: 10px;" class="mb-3">Bài viết</h5>
            <div style="margin-left: 50px;margin-bottom: 30px;">
	            <div style="width:900px;text-align: justify;">${blog.getNoiDung() }</div>
            </div>

...
<body>
    <div class="bg">
    <jsp:include page="/WEB-INF/pages/layout/navbarhi.jsp" />
    <div style="height:70px;">
    </div>
    <div class="container">
        <form class="row ">
          <h3 style="color: rgb(6, 109, 70);" class="mb-5 mt-4">Đăng ký tài khoản doanh nghiệp</h3>
          <!-- Thong tin dang nhap -->
          <div class="mb-4 mySlides" >
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="password" class="form-control" id="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required="required">
                <small><i><b>Lưu ý: </b>Mật khẩu tối thiểu 8 ký tự, trong đó có ít nhất 1 ký tự chữ và 1 ký tự số.</i></small>
              </div>

            </div>
            <div class="row mb-3">
              <label for="password" class="col-sm-2 col-form-label">Xác nhận lại mật khẩu<span class="required"> *</span></label>
              <div class="col-sm-10">
          ...
          <div class="mb-4 mySlides" style="display: none;">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="contactName" required="required">
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="tel" class="form-control" id="contactTel" pattern="0[3578][0-9]{1}-[0-9]{3}-[0-9]{4}" placeholder="037-655-1445" required="required">
          ...
          <div class="mb-4 mySlides" style="display: none;">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" id="enterpriseName" required="required">
              </div>
            </div>
            <div class="row mb-3">
              <label for="taxCode" class="col-sm-3 col-form-label">Mã số thuế<span class="required"> *</span></label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="taxCode" minlength="10" maxlength="13" required="required">
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <select class="form-select" aria-label="Default select example" id="city" required="required">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <select class="form-select" aria-label="Default select example" id="district" required="required">
                  <option selected disabled>----------</option>
                  <option value="1">One</option>
                  <option value="2">Two</option>
                  <option value="3">Three</option>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <select class="form-select" aria-label="Default select example" id="ward" required="required">
                  <option selected disabled>----------</option>
                  <option value="1">One</option>
                  <option value="2">Two</option>
                  <option value="3">Three</option>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <select class="form-select" aria-label="Default select example" id="field" required="required">
                  <option selected disabled>----------</option>
                  <option value="1">One</option>
                  <option value="2">Two</option>
                  <option value="3">Three</option>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <select class="form-select" aria-label="Default select example" id="enterpriseType" required="required">
                  <option selected disabled>----------</option>
                  <option value="1">One</option>
                  <option value="2">Two</option>
                  <option value="3">Three</option>
          ...
          <div class="mb-4 mySlides" style="display: none;">  
            ...
            <div class="row mb-3">
              <label for="enterpriseType" class="col-sm-6 col-form-label">Tải lên giấy phép kinh doanh/Giấy chứng nhận thành lập công ty/Giấy chứng nhận đăng ký thuế của doanh nghiệp<span class="required"> *</span></label>
              <div class="col-sm-6">

...
<body>
    ...
    <div  class="row">
    	<div class="col-5">
        	<input type="text" class="form-control" id="key" placeholder="Nhập kỹ năng cần thiết" >
        </div>
       
    	<div class="col-2">
        	<select class="form-select" name="cmbSinhVienNam" id="nam">
        ...
        <div class="col-2">
        	<select class="form-select" name="cmbmaNDT" id="maNganhDaoTao">
        ...
        <div class="col-2">
        	<select class="form-select" name="cmbGPA" id="loaiGPA">
        ...
        <div class="col-1">
            <button class="btn btn-primary" onclick="timKiemSinhVien()"><i class="fas fa-search"></i></button>
        </div>
    </div>
    <hr>
    <div id="sinhvien">
    ...
    function timKiemSinhVien(){
    	...
    	var maNganhDaoTao=document.getElementById("maNganhDaoTao").value;
    	var loaiGPA=document.getElementById("loaiGPA").value;
		$.ajax({ 
		    type:"post", 
		    url: "/sinhvien/timkiem", 
		    ...
		    success: function(data) { 
		    	let row = document.getElementById("sinhvien");
		    	row.innerHTML = data;
		    },
		})
	};
